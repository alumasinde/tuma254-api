package favourites
import("context";"errors";"go.mongodb.org/mongo-driver/v2/bson";"go.mongodb.org/mongo-driver/v2/mongo")
...
func(r *Repository)Add(ctx context.Context,v Rider)(Rider,error){_,e:=r.db.Collection("favourite_riders").UpdateOne(ctx,bson.M{"senderId":v.SenderID,"riderId":v.RiderID},bson.M{"$setOnInsert":v},mongoOptions());if e!=nil{return v,e};return v,nil}
func mongoOptions()*mongo.UpdateOptions{return &mongo.UpdateOptions{Upsert:true}}
